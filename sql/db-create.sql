...
values (default, 'All about psychology',
        ...
        'Klynove, 15, Khmelnytskyi region, 32048, Ukraine', FROM_UNIXTIME(1674291600), 1, false, -1, 'en');
insert into events
values (default, 'Financial literacy',
        ...
        'Brovary, 21, Poltava region, 38425, Ukraine', FROM_UNIXTIME(1674309600), 1, false, -1, 'en');
insert into events
values (default, 'What is programming?',
        ...
        'Brovary, 9, Rivne region, 34135, Ukraine', FROM_UNIXTIME(1673791200), 1, false, -1, 'en');
insert into events
values (default, 'Healthy Eating',
        'Eating a healthy diet is not about strict limitations, staying unrealistically thin, or depriving yourself of the foods you love. Rather, it’s about feeling great, having more energy, improving your health, and boosting your mood.',
        'Lviv, 8, Lviv region, 80081, Ukraine', FROM_UNIXTIME(1673965800), 1, false, -1, 'en');
insert into events
values (default, 'Is programming hard?',
        ...
        'Lviv, 15, Vinnytsia region, 22714, Ukraine', FROM_UNIXTIME(1674484200), 1, false, -1, 'en');
insert into events
values (default, 'Global warming',
        ...
        'Lutsk, 12, Poltava region, 39232, Ukraine', FROM_UNIXTIME(1674381600), 1, false, -1, 'en');
insert into events
values (default, 'A Nuclear War Could Starve Billions, But One Country May Be Safer Than The Rest',
        ...
        'Kalush, 23, Mykolaiv region, 56020, Ukraine', FROM_UNIXTIME(1674554400), 1, false, -1, 'en');
insert into events
values (default, 'Is artificial intelligence a threat to our existence?',
        ...
        'Chernivtsi, 7, Kyiv region, 7250, Ukraine', FROM_UNIXTIME(1674561600), 1, false, -1, 'en');
insert into events
values (default, 'How harmful is smoking?',
        'Smoking causes cancer, heart disease, stroke, lung diseases, diabetes, and chronic obstructive pulmonary disease (COPD), which includes emphysema and chronic bronchitis. Smoking also increases risk for tuberculosis, certain eye diseases, and problems of the immune system, including rheumatoid arthritis.',
        'Dobromil, 24, Vinnytsia region, 22036, Ukraine', FROM_UNIXTIME(1674648000), 1, false, -1, 'en');
insert into events
values (default, 'How Does Warren Buffett Choose His Stocks?',
        ...
        'Lviv, 1, Poltava region, 39213, Ukraine', FROM_UNIXTIME(1674734400), 1, false, -1, 'en');
insert into events
values (default, 'Social engineering',
        'Social engineering is the term used for a broad range of malicious activities accomplished through human interactions. It uses psychological manipulation to trick users into making security mistakes or giving away sensitive information.',
        'Lviv, 29, Chernihiv region, 16707, Ukraine', FROM_UNIXTIME(1674820800), 1, false, -1, 'en');
...
values (default, 'Все про психологію',
        ...
        'Клинове, 15, Хмельницька область, 32048, Україна', FROM_UNIXTIME(1674291600), 1, false, -1, 'uk');
insert into events
values (default, 'Фінансова грамотність',
        ...
        'Бровари, 21, Полтавська область, 38425, Україна', FROM_UNIXTIME(1674309600), 1, false, -1, 'uk');
insert into events
values (default, 'Що таке програмування?',
        ...
        'Бровари, 9, Рівненська область, 34135, Україна', FROM_UNIXTIME(1673791200), 1, false, -1, 'uk');
insert into events
values (default, 'Здорове харчування',
        ...
        'Львів, 8, Львівська область, 80081, Україна', FROM_UNIXTIME(1673965800), 1, false, -1, 'uk');
insert into events
values (default, 'Чи важко програмувати?',
        ...
        'Львівська, 15, Вінницька область, 22714, Україна', FROM_UNIXTIME(1674484200), 1, false, -1, 'uk');
insert into events
values (default, 'Глобальне потепління',
        ...
        'Луцька, 12, Полтавська область, 39232, Україна', FROM_UNIXTIME(1674381600), 1, false, -1, 'uk');
insert into events
values (default,
        ...
        'Калуш, 23, Миколаївська область, 56020, Україна', FROM_UNIXTIME(1674554400), 1, false, -1, 'uk');
insert into events
values (default, 'Чи загрожує штучний інтелект нашому існуванню?',
        ...
        'Чернівці, 7, Київська область, 7250, Україна', FROM_UNIXTIME(1674561600), 1, false, -1, 'uk');
insert into events
values (default, 'Наскільки шкідливим є куріння?',
        ...
        'м. Добромиль, вул. Шевченка, 24, Вінницька область, 22036, Україна', FROM_UNIXTIME(1674648000), 1, false, -1,
        'uk');
insert into events
values (default, 'Як Уоррен Баффет вибирає акції?',
        ...
        'вул. Львівська, 1, Полтавська область, 39213, Україна', FROM_UNIXTIME(1674734400), 1, false, -1, 'uk');
insert into events
values (default, 'Соціальна інженерія',
        ...
        'Львівська, 29, Чернігівська область, 16707, Україна', FROM_UNIXTIME(1674820800), 1, false, -1, 'uk');
